...
import com.study.jpastudy.chap06_querydsl.entity.*;
...
import static com.study.jpastudy.chap06_querydsl.entity.QAlbum.album;
import static com.study.jpastudy.chap06_querydsl.entity.QGroup.*;
...
class QueryDslJoinTest {
    ...
    void innerJoinTest() {
        ...
        List<Tuple> idolList = factory
                .select(idol, group)
                .from(idol)
                // 첫번쨰 파라미터는 from 절에 있는 엔터티의 연관 객체
...
//
    ...
    void test2() {
        ...
        List<Tuple> fetch = factory
                ...
                .having(idol.age.avg().intValue().goe(22))
                .fetch();
        //then
